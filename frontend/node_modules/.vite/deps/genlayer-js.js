...
// node_modules/genlayer-js/dist/chunk-GACCNOPJ.js
...
var contractActions = (client, publicClient) => {
  return {
    ...
    readContract: async (args) => {
      ...
      const senderAddress = (account == null ? void 0 : account.address) ?? ((_a = client.account) == null ? void 0 : _a.address);
      const requestParams = {
        type: "read",
        to: address,
        from: senderAddress,
...
var _sendTransaction = async ({
  ...
  const encodedData = encodeFunctionData({
    abi: (_b = client.chain.consensusMainContract) == null ? void 0 : _b.abi,
  ...
  const transactionRequest = await client.prepareTransactionRequest({
    ...
    to: (_c = client.chain.consensusMainContract) == null ? void 0 : _c.address,
    data: encodedData,
    type: "legacy",
    nonce: Number(nonce),
    value: value ?? 0n
  });
  if ((senderAccount == null ? void 0 : senderAccount.type) !== "local") {
  ...
  if (!(senderAccount == null ? void 0 : senderAccount.signTransaction)) {
  ...
  const newTxEvents = parseEventLogs({
    abi: (_d = client.chain.consensusMainContract) == null ? void 0 : _d.abi,
...
var transactionActions = (client, publicClient) => ({
  getTransaction: async ({ hash }) => {
    ...
    const transaction = await publicClient.readContract({
      address: (_a = client.chain.consensusDataContract) == null ? void 0 : _a.address,
      abi: (_b = client.chain.consensusDataContract) == null ? void 0 : _b.abi,
...
function chainActions(client) {
  return {
    initializeConsensusSmartContract: async (forceReset = false) => {
      var _a, _b, _c;
      if (((_a = client.chain) == null ? void 0 : _a.id) === testnetAsimov.id) {
        return;
      }
      if (!forceReset && ((_b = client.chain.consensusMainContract) == null ? void 0 : _b.address) && ((_c = client.chain.consensusMainContract) == null ? void 0 : _c.abi)) {
        return;
      }
  ...
  return {
    async request({ method, params = [] }) {
      ...
      if (method.startsWith("eth_") && isAddress2) {
        try {
          return await ((_a = window.ethereum) == null ? void 0 : _a.request({ method, params }));
        } catch (err) {
